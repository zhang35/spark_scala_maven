...
/**
  ...
  * version: 
  */
class PointWithSegID extends Serializable {
...
//  var dateTime: DateTime = _
  ...
  override def equals(obj: Any): Boolean = {
    ...
    //类型匹配
    obj match {
      case v: PointWithSegID =>
        val pt: PointWithSegID = v.asInstanceOf[PointWithSegID]
  ...
  /**
    ...
    * @return 位置一样 返回true
    */
  def samePosition(point: PointWithSegID): Boolean = {
